            ...
            <ul class="nav-menu navbar-nav ml-auto">
              ...
              <li id="header-user-avatar-left" class="last-item nav-item dropdown">
                ...
                >
                  <span id="flag_container" class="mr-2">
                    <img
                      :src="
                        player.avatar
                          ? `/upload/images/users/${player.avatar}`
                ...
                >
                  ...
                  <router-link
                    class="dropdown-item"
                    :to="{ name: 'MyTeamsPlayer' }"
                    >{{
                      $options.filters.capitalizeText($tc("myFeminine", 2)) +
                        " " +
                        $tc("team", 2)
                    }}</router-link
                  >
              ...
              <template v-if="teamFeaturesVisible">
                <li class="nav-item">
              ...
              <li class="nav-item">
                <router-link
                  class="nav-link"
                  :to="{ name: 'Duels', params: { username: user.username } }"
                >
                  <img
                    class="mr-2"
                    src="/images/icons/bestfootball-start-no-bg-white.png"
...
export default {
  ...
  computed: {
    ...
    teamFeaturesVisible() {
      return this.$store.state.user.teamFeaturesVisible;
    },
  },
};
</script>
