                ...
                <div class="col-lg-4 md-mb-50">
                    <div class="player-image">
                        ...
                        <div class="name-box">
                            ...
                            <template v-if="teams.length && teams[0].club && teams[0].club.id">
                                <span class="player-position">{{$tc('coach') | capitalizeText}}</span>
                                <span class="club">{{ teams[0].club.name }}</span>
                            </template>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input 
                                                        ...
                                                        v-model.trim="form.years_experience"
                                                    />
                                                </div>                                                
                                                <div class="col-md-6">
                                                    <label class="input-label">
...
export default {
    ...
    computed: {
        ...
        profile() {
            return this.user ? this.user.coach : {}
        },
